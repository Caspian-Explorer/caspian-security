...
- **Security Task Management** -- 23 recurring security tasks across all 14 categories with configurable intervals, overdue reminders, auto-completion on scans, per-project persistence, and a dedicated detail panel for viewing and managing tasks. Open the checklist in the sidebar, or click the **Open Security Tasks in Editor** button in its title bar for a full-width editor tab
